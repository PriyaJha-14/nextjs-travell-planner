    ...
    >
      ...
      <div className="relative z-10 p-4 grid grid-cols-4 gap-20 text-white">
        ...
        <div className="flex flex-col gap-3 pt-10">
          {/* 🔥 Changed to pink */}
          <h3 className="text-3xl font-medium text-pink-500">Destinations</h3>
        ...
        <div className="flex flex-col gap-3 pt-10">
          {/* 🔥 Changed to pink */}
          <h3 className="text-3xl font-medium text-pink-500">Adventures</h3>
          <ul className="flex flex-col gap-1">
        ...
        <div className="flex flex-col gap-3 pt-10">
          <h3 className="text-3xl font-medium text-pink-500">Get in Touch</h3>
